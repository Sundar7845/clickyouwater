...
(function () {
    ...
    // console.log($("a[href='" + loc + "']").parent().offset().top + " - " + $(window).height());
    if (
        $("a[href='" + loc + "']")
            .parent()
            .offset() != undefined
    ...
    // var h1_list = document.getElementsByClassName($("a[href='" + loc + "']").parent()[0].className);
    // console.log(h1_list);
    // console.log($("a[href='" + loc + "']").parent());

    // h1_list[0].scrollIntoView({ behavior: 'smooth', block: 'start', inline: 'start' });
...
$(document).ready(function () {
    ...
    $("#salesinvdate").val(today);
    $("#salesexpecdate").val(today);
    $("#salesorddate").val(today);
    $("#purexpecdate").val(today);
    $("#dtPaymentDate").val(today);
    $("#invdate").val(today);
    $("#purinvdate").val(today);
    $("#purreturndate").val(today);
    $("#dtOutwardTodayDate").val(today);
    $("#dtAdminOrderDate").val(today);
