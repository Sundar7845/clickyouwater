...
class AssetTypeController extends Controller
{
    ...
    {
        try {
            $assetTypeData = AssetType::select('asset_types.*', 'assets.asset_type_id')
                ->leftJoin('assets', 'assets.asset_type_id', 'asset_types.id')
            ...
            return datatables()->of($assetTypeData)
                ...
                onclick="doEdit(' . $row->id . ');"></i> ';
                    ...
                    if ($this->isUserHavePermission(MenuPermissionType::Delete) && $row->asset_type_id == null) {
