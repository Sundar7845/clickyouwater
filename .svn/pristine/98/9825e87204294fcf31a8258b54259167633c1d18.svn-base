...
class DesignationController extends Controller
{
    ...
    public function addDesignation(Request $request)
    {
        $request->validate([
            'txtDesignationName' => [
                'required',
                Rule::unique('designations', 'designation_name')->WhereNull('deleted_at')->ignore($request->hdDesignationId),
            ],
        ], [
    ...
    {
        try {
            $designationData = Designation::select('designations.*', 'employees.designation_id')
                ->leftJoin('employees', 'employees.designation_id', 'designations.id')
            ...
            return datatables()->of($designationData)
                ...
                onclick="doEdit(' . $row->id . ');"></i> ';
                    ...
                    if ($this->isUserHavePermission(MenuPermissionType::Delete) && $row->designation_id == null) {
