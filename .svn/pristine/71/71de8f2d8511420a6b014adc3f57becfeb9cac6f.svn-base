...
function getProductTypeById(id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#txtdescription").val(data.ProductType.desc);console.log(data.ProductType.is_elite);
            $("#chkElite").val(data.ProductType.is_elite).prop("checked", data.ProductType.is_elite === 1);
            $("#pageloader").fadeOut();
        },
    });
}
