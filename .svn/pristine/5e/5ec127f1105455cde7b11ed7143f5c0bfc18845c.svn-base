...
@section('content')
@section('title')
Purchase Return | Click Your Order | Dashboard
@endsection
          ...
          <div class="card-body">
            <form class="browser-default-validation">
              <div class="row">
                <div class="col-md-3">
                  <div class="mb-3">
                    <label class="form-label" for="basic-default-name">Supplier Name</label>
                ...
                <div class="col-md-3">
                  <div class="mb-3">
                    <label class="form-label" for="basic-default-name">Purchase Invoice No</label>
                    <select name="" id="" class="select2 form-select ">
                ...
                <div class="col-md-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text" id="basic-addon11">PR.No.</span>
                    <input type="text" class="form-control" placeholder="PR0025" disabled aria-label="Username" aria-describedby="basic-addon11"/>
                  </div>
                </div>
                <div class="col-md-3">
                  <label class="form-label" for="basic-default-name">&nbsp;</label>
                  <div class="input-group">
                    <span class="input-group-text" id="basic-addon11">PR.Date</span>
                ...
                <div class="row">
                  ...
                  <div class="col-md-5 mt-4">
                    <div class="form-group input-group mb-3">
                      ...
                      <input type="text" disabled="disabled" tabindex="-1" class="form-control" id="txtTaxableAmount" value="0.00" style="text-align: right;" />
                    </div>
                    <div class="form-group input-group mb-3">
                      <span class="input-group-text">Tax Amount</span>
                      <input type="text" disabled="disabled" tabindex="-1" class="form-control" id="txtTaxAmount" value="0.00" style="text-align: right;" />
                    </div>
                    <div class="form-group input-group mb-3">
                      <span class="input-group-text">Sub Total</span>
                      <input type="text" disabled="disabled" tabindex="-1" id="txtSubTotal" class="form-control" value="0.00" style="text-align: right;" />
                    </div>
                    <div class="form-group input-group mb-3">
