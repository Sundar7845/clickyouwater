                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="ddlHubName[]" id="ddlHubName" class="select2 form-select "
                                        title="Enter Hub Name" multiple required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="txtAddress" id="txtAddress" class="form-control"
                                        placeholder="Enter Door No / Street / Landmark" value="{{ $log->address }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="txtPincode" id="txtPincode"
                                        ...
                                        value="{{ $log->pincode }}" title="Enter Pin Code" required>
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-between">
                                <div class="mt-4 mb-3">
                                    ...
                                    <a href="{{ route('logisticList') }}" class="btn btn-danger">Cancel</a>
                                </div>
                                <div class="mt-4 mb-3">
