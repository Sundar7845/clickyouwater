...
@section('content')
@section('title')
    Ledger | Click Your Order | Dashboard
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('addledger') }}" id="ledger" name="ledger" method="POST">
                        ...
                        <input type="hidden" name="hdLedgerCode" id="hdLedgerCode" value="{{ $ledExample }}">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-email">Ledger Type<span
                                            class="text-danger">*</span></label>
                                    <select name="ddlLedgertype" id="ddlLedgertype" class="select2 form-select "
                                        title="Select Ledger Type" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="txtLedgername" id="txtLedgername" class="form-control"
                                        ...
                                        value="{{ old('txtLedgername') }}" required />
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label">Credit Period <small
                                            class="text-muted">(days)</small><span class="text-danger">*</span>
                                    </label>
                                    <div class="">
                            ...
                            {{-- <div class="col-md-4">
                                <label class="form-label" for="basic-default-name">Balance</label>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label">Settlement Period <small
                                            class="text-muted">(days)</small><span class="text-danger">*</span>
                                    </label>
                                    <div class="">
