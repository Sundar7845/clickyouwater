            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('add.products') }}" method="POST" name="products"
                        ...
                        <input type="hidden" name="hdProductImg" id="hdProductImg">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="ddlProducttype" placeholder="Select Product Type" id="ddlProducttype" class="select2 form-select"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="ddlBrand" id="ddlBrand" placeholder = "Select Brand" class="select2 form-select"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label" for="txtHsnSaccode">HSN/SAC Code<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="txtHsnSaccode" id="txtHsnSaccode" class="form-control"
                                        placeholder="HSN/SAC Code"  title="Enter HSN/SAC code"
                                        value="{{ old('txtHsnSaccode') }}" required />

                                    @if ($errors->has('txtHsnSaccode'))
                                        <div class="text-danger">{{ $errors->first('txtHsnSaccode') }}</div>
                                    @endif
                                    <span class="error"></span>
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label" for="txtExpirydurationIndays">Expiry Duration In Days<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="txtExpirydurationIndays" id="txtExpirydurationIndays" class="form-control"
                                        placeholder="Expiry Duration In Days"  title="Enter Expiry Duration In Days"
                                        value="{{ old('txtExpirydurationIndays') }}" required />

                                    @if ($errors->has('txtExpirydurationIndays'))
                                        <div class="text-danger">{{ $errors->first('txtExpirydurationIndays') }}</div>
                                    @endif
                                    <span class="error"></span>
                                </div>
                            </div> --}}
