...
class CategoryController extends Controller
{
        ...
        try {
            if ($request->hdCategoryId == null) {
                ...
                Category::create([
                    ...
                    'is_watercan' => $request->chkWaterCan ?? 0,
    ...
    {
        try {
            $categoryData = Category::select('categories.*', 'brands.category_id as brands_category_id', 'product_types.category_id as product_types_category_id')
                ->leftJoin('brands', 'brands.category_id', 'categories.id')
            ...
            return datatables()->of($categoryData)
                ...
                onclick="doEdit(' . $row->id . ');"></i> ';
                    ...
                    if ($this->isUserHavePermission(MenuPermissionType::Delete) && $row->brands_category_id == null && $row->product_types_category_id == null) {
