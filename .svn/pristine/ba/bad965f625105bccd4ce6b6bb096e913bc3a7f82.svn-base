...
@section('content')
@section('title')
    Logistic Vehicle Info | Click Your Order | Dashboard
@endsection
<!-- Content -->
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @endif
                                    <input type="hidden" name="hdLogisticPartnerId" id="hdLogisticPartnerId" value="{{ $logistic_partner_id }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="ddlFuelType" id="ddlFuelType" class="select2 form-select"
                                        ...
                                        @foreach ($fuelTypes as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('ddlFuelType') == $item->id ? 'selected' : '' }}>
                                                {{ $item->fuel_type }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="ddlVehicleType" id="ddlVehicleType" class="select2 form-select"
                                        ...
                                        @foreach ($vehicleTypes as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('ddlVehicleType') == $item->id ? 'selected' : '' }}>
                                                {{ $item->vehicle_type }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label" for="txtWeight">Weight <small
                                            class="text-muted">(KG)</small><span class="text-danger">*</span></label>
