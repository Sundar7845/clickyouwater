        ...
        try {
            ...
            if ($status) {
                ...
                if (strtolower($validated_data['transaction_status']) == 'success') {
                    ...
                    $this->sendWalletNotification($wallet->amount, WalletTransactionTypes::WalletSuccess);
                } else {
                    $this->sendWalletNotification($wallet->amount, WalletTransactionTypes::WalletFailed);
                }
            }
