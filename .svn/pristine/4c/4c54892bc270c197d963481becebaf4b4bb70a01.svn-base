...
@section('content')
@section('title')
    Notification Config | Click Your Order | Dashboard
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="txtMessageFormat" class="form-control" id="txtMessageFormat" value="" placeholder="Enter Message Format">
