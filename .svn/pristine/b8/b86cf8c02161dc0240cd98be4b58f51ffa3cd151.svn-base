...
use App\Http\Controllers\API\Delivery\DPSurrenderOrdersController;
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('/checkProductStatus/{product_id}', [ProductsController::class, 'checkProductStatus']);
    ...
    Route::post('/getSurrenderOrderHistory', [SurrenderOrdersController::class, 'getSurrenderOrderHistory']);
    ...
    Route::group(['prefix' => 'delivery'], function () {
        ...
        Route::get('/getDPPickupOrders', [DPSurrenderOrdersController::class, 'getDPPickupOrders']);
        Route::get('/getDPPickupOrderDetails/{id}', [DPSurrenderOrdersController::class, 'getDPPickupOrderDetails']);
        Route::post('/confirmPickup', [DPSurrenderOrdersController::class, 'confirmPickup']);
    });
    ...
    Route::group(['prefix' => 'hub'], function () {
        ...
        Route::post('/assignSurrenderPickup', [HubOrdersController::class, 'assignSurrenderPickup']);
        ...
        Route::get('/getHubStocks', [HubController::class, 'getHubStocks']);
        Route::post('/updateLostDamagedHubStocks', [HubController::class, 'updateLostDamagedHubStocks']);
        Route::post('/getLogisticsOrderItemsList', [HubController::class, 'getLogisticsOrderItemsList']);
        Route::post('/collectLogiticsOrderItems', [HubController::class, 'collectLogiticsOrderItems']);
        Route::post('/returnHubEmptyStocks', [HubController::class, 'returnHubEmptyStocks']);
        Route::post('/updateDPExtraItems', [HubController::class, 'updateDPExtraItems']);
        Route::post('/removeDPExtraItems', [HubController::class, 'removeDPExtraItems']);
        Route::post('/getDPOrdersSummary', [HubOrdersController::class, 'getDPOrdersSummary']);
        Route::post('/getDPLostItems', [HubOrdersController::class, 'getDPLostItems']);
        Route::post('/getDPReturnCans', [HubOrdersController::class, 'getDPReturnCans']);
        Route::post('/getDPReturnCans', [HubOrdersController::class, 'getDPReturnCans']);
        Route::post('/collectDPReturnCans', [HubOrdersController::class, 'collectDPReturnCans']);
    });

    //Logistics Partner App
    Route::group(['prefix' => 'logistics'], function () {
        Route::get('/getLPUserInfo', [LogisticsController::class, 'getLPUserInfo']);
        Route::post('/startTrip', [LogisticsController::class, 'startTrip']);
        Route::get('/endTrip', [LogisticsController::class, 'endTrip']);
        Route::get('/getHubOrdersInfo', [LogisticsController::class, 'getHubOrdersInfo']);
        Route::post('/getHubStocks', [LogisticsController::class, 'getHubStocks']);
        Route::get('/getBookedItems', [LogisticsController::class, 'getBookedItems']);
        Route::post('/bookItems', [LogisticsController::class, 'bookItems']);
        Route::get('/cancelAllBookings', [LogisticsController::class, 'cancelAllBookings']);
        Route::get('/confirmBooking', [LogisticsController::class, 'confirmBooking']);
        Route::get('/getDeliveryToFactory', [LogisticsController::class, 'getDeliveryToFactory']);
        Route::post('/getDeliveryToHub', [LogisticsController::class, 'getDeliveryToHub']);
        Route::post('/getHubReturnItems', [LogisticsController::class, 'getHubReturnItems']);
        Route::post('/confirmReturnItems', [LogisticsController::class, 'confirmReturnItems']);
        Route::get('/getDeliveryHistory', [LogisticsController::class, 'getDeliveryHistory']);
    });
    ...
    Route::group(['prefix' => 'manufacturer'], function () {
        ...
        Route::get('/getOtherItemStocks/{category_id?}', [ManufactureController::class, 'getOtherItemStocks']);
        Route::post('/addOtherItemsStock', [ManufactureController::class, 'addOtherItemsStock']);
        Route::post('/removeOtherItemsStock', [ManufactureController::class, 'removeOtherItemsStock']);
        ...
        Route::get('/getLogisticPartnerList', [ManufactureController::class, 'getLogisticPartnerList']);
        Route::get('/getBookedReturnStocks/{driver_id}', [ManufactureController::class, 'getBookedReturnStocks']);
        Route::post('/collectReturnStocks', [ManufactureController::class, 'collectReturnStocks']);
        Route::post('/deliverBookedItems', [ManufactureController::class, 'deliverBookedItems']);
        Route::get('/getAlertMessages', [ManufactureController::class, 'getAlertMessages']);
    });
});
