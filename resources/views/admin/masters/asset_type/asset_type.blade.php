...
@section('content')
@section('title')
    Asset Type | Click Your Order | Dashboard
@endsection
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="txtAssetType" id="txtAssetType"
                                        placeholder="Asset Type" title="Enter Asset Type" value="{{old('txtAssetType')}}" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="txtPrefix" id="txtPrefix"
                                        placeholder="Asset Prefix" title="Enter Asset Prefix" value="{{old('txtPrefix')}}" required>
