...
@section('content')
@section('title')
    Payment Methods | Click Your Order | Dashboard
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="ddlCustomerType" id="ddlCustomerType" class="select2 form-select" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="ddlPaymentMethod[]" id="ddlPaymentMethod" class="select2 form-select" multiple="multiple" required>
