    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <label class="form-label" for="ddlHub">Select Hub <span class="text-danger">*</span>
                        </label>
                        <select name="ddlHub" id="ddlHub" class="select2 form-select" title="Select Hub"
                            required>
                            <option value="">Select Hub</option>
                            @foreach ($hubs as $item)
                                <option value="{{ $item->id }}"
                                    {{ old('ddlHub') == $item->id ? 'selected' : '' }}>
    ...
    <div class="col-lg-12 mt-2 mb-4 mb-lg-0">
        <div class="card h-100">
            <div class="card-datatable table-responsive pt-0">
                <table id="tblHubStockList" class="table">
...
@endsection
@section('footer')
<script src="{{ asset('assets/js/admin/reports/hub_stock.js') }}"></script>
@endsection