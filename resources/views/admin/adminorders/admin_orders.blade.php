...
@section('content')
@section('title')
    Admin Order | Click Your Order | Dashboard
@endsection
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-12 mb-4 mb-md-0">
            <form action="{{ route('add.addadminorder') }}" method="POST" name="adminPlaceOrder" id="yourFormId">
                @csrf
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <div class="card-datatable table-responsive pt-0">
                                    <table class="table table-responsive">
                                        ...
                                        <tbody id="tbodyPlaceAdminOrders">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-between">
                                ...
                                <div class="mt-4 mb-3">
                                    <a href="{{ route('adminorderlist') }}"><button type="button"
