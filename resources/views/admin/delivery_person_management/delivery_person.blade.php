...
@section('content')
@section('title')
    Delivery Person | Click Your Order | Dashboard
@endsection
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="fileDelPersonImage" class="form-label">Delivery Person
                                            Image</label>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="txtPincode" id="txtPincode" class="form-control numvalidate"
                                placeholder="Pincode" value="{{ old('txtPincode') }}" title="Enter Pincode"
                                required />
                ...
                @if ($bindDocuments->count() > 0)
                    ...
                    <div class="row">
                        @foreach ($bindDocuments as $item)
                            ...
                            <div class=" col-md-4">
                                <div class="mb-3">
                                    <label for="file_{{ $item->id }}" class="form-label">Upload File <sup>(PDF
                                            only)</sup>
                                        @if ($item->is_mandatory == 1)
                                            <span class="text-danger">*</span>
                                        @endif
